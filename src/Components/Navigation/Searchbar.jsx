  ...
  return (
    <form className="searchbar" onSubmit={handleSubmitSearchCountry}>
      ...
      <div className="searchbar__wrapper">
        ...
        <svg className="searchbar__icon" xmlns="http://www.w3.org/2000/svg" width="14" height="14.001" viewBox="0 0 14 14.001">
        ...
        <button 
          ...
          <svg aria-hidden className="searchbar__reset-icon" xmlns="http://www.w3.org/2000/svg" width="14" height="12.966" viewBox="0 0 14 12.966">
            <g id="reset" transform="translate(0 -17.983)">
              <path id="Path_2" data-name="Path 2" d="M7.518,17.983A6.462,6.462,0,0,0,1.653,21.7L.922,20.177,0,20.622l1.518,3.151,3.151-1.518-.444-.922-1.641.791a5.462,5.462,0,1,1,.47,5.486l-.837.59a6.483,6.483,0,1,0,5.3-10.216Z" transform="translate(0 0)"/>
            </g>
          </svg>
