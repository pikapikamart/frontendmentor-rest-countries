  ...
  return (
    <header className='header'>
      ...
      <fieldset className="colormodes">
        ...
        <input className="colormodes__input" type="radio" name="colormode" id="lightmode" aria-label="lightmode" defaultChecked/>
        <label className="colormodes__toggler" htmlFor="lightmode"></label>
        <input className="colormodes__input" type="radio" name="colormode" id="darkmode" />
